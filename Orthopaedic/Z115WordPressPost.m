...
- (NSString *)generateHtml:(int)fontSize
{
    if (!self.postHtml)
    {
        ...
        [html appendFormat:@"<html><head> <meta name=\"viewport\" content=\"width=device-width, user-scalable=no initial-scale=1.0\" /><script type=\"text/javascript\" src=\"z115wordpress.js\"></script>"];
